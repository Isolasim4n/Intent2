    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.buttonInput).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivityForResult(new Intent(MainActivity.this, ActivityInput.class), REQUEST_CODE);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                String nama = data.getStringExtra(ActivityInput.NAMA);
                int thnLhr = data.getIntExtra(ActivityInput.TAHUN_LAHIR, 0);
